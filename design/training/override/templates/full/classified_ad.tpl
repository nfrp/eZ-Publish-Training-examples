                ...
                <div class="border-ml"><div class="border-mr"><div class="border-mc float-break">
                        ...
                        <div class="content-view-full">
                            <div class="class-blog-post float-break">
                                ...
                                <div class="attribute-byline classified-metadata">
                                    <p class="date">{$node.object.published|l10n(shortdatetime)}</p>
                                    <p class="author">{"by"|i18n("design/training")} {$node.object.owner.name}</p>
                                    {*
                                    ...
                                    *}
                                    <p class="author soft-navigation">
                                    <a href="#location">{"Location"|i18n("design/training")}</a> | <a href="#comments">{"Comments"|i18n("design/training")}</a>{if $gallery.0.children|count} | <a href="#gallery">{"Gallery"|i18n("design/training")}</a>{/if}
                                    </p>
                                </div>
                                
                                <div class="attribute-body main-classified-image">
                                    {attribute_view_gui attribute=$node.data_map.image image_class='articlethumbnail'}
                                </div>
                                
                                <div class="attribute-body float-break classified-description">
                                    {attribute_view_gui attribute=$node.data_map.description}
                                </div>

                                {if $gallery.0.children|count}
                                <div class="attribute-body float-break" id="gallery">
                                    {include uri="design:carousel/multimedia_carousel.tpl" params=hash( 'id', $gallery.0.node_id,
                                                                                                        'pictures', $gallery.0.children,
                                                                                                        'name', ''  )}
                                </div>            
                                {/if}                    
                                
                                <div class="attribute-body float-break horizontal-separator" id="location">
                                ...
                                <div class="attribute-comments horizontal-separator" id="comments">
